...
#define SHKMyAppName			@"iScab"
#define SHKMyAppURL				@"http://beefbrain.com"
...
#define SHKTwitterUsername			@"iscabtweets" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
